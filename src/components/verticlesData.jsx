const VerticalCard = ({ icon, title , images }) => (
  <div
    className="w-full cursor-pointer mt-12 bg-white rounded-2xl shadow-sm hover:shadow-md p-6 flex flex-col items-center justify-center transition-all duration-300 text-center border border-gray-100"
  >
