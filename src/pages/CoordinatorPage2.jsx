...
const coordinators = [
  {
    ...
    imageUrl:
      "https://images.news18.com/ibnlive/uploads/2022/03/iit-guwahati-164665401116x9.jpg",
  },
];
...
const IHGT = [
  ...
  },
  {
    ...
    affiliation: "  ",
    website:
      "https://www.iitg.ac.in/civil/home_faculty_profile.php?slno=S1FHM3A5ZDNvWFpaSlluVzNRTHZ2Zz09",
    imageUrl:
      "https://www.iitg.ac.in/civil/faculty/a4bbc816a415c026f6658674b0c21ee42d8128fejpeg",
  },
];
...
const THAS = [
...

  {
    ...
    imageUrl:
      "https://www.iitg.ac.in/eee/faculty/d19bc93884b38e4c09c1ccbc505ccab4.jpg",
  },
  {
    ...
    imageUrl:
      "https://www.iitg.ac.in/eee/faculty/b6503d48be1e2ee97f22d06bf3d30631.jpg",
  },
  {
...
const BPWM = [
  {
    ...
    imageUrl:
      "https://www.iitg.ac.in/chemeng/faculty/eaec5dc6f1a635760907dcb8f702f584.jpg",
  },
  {
...

  {
    ...
    imageUrl:
      "https://www.iitg.ac.in/chemeng/faculty/646a8812bcc9f8acfb7c40a3ff9e606a.jpg",
  },
  {
    ...
    imageUrl:
      "https://www.iitg.ac.in/chemeng/faculty/075425f5976765e745fe90b7f0369d7a.jpg",
  },
  {
    ...
    imageUrl:
      "https://www.iitg.ac.in/chemeng/faculty/d745db61aae61a5d4bb97fee0ebbae69026025a6.jpg",
  },
  {
    ...
    imageUrl:
      "https://static.wixstatic.com/media/9462d9_847f2536e21d4612a9106f61da4366e1~mv2.jpg/v1/fill/w_186,h_241,al_c,q_80,usm_0.66_1.00_0.01,enc_avif,quality_auto/9462d9_847f2536e21d4612a9106f61da4366e1~mv2.jpg",
  },
];
  ...
  return (
    <section className="relative py-20">
      ...
      <div className="relative max-w-7xl mx-auto px-6">
        ...
        {/* Grid */}
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 xl:grid-cols-4 gap-7">
          {THAS.slice(0, Math.floor(THAS.length / 4) * 4).map((m) => (
            <CoordinatorCard key={m.name} member={m} />
          ))}
        </div>
        <div className="flex justify-center mt-7 mr-7 gap-7">
          {THAS.slice(Math.floor(THAS.length / 4) * 4).map((m) => (
            <CoordinatorCard key={m.name} member={m} />
          ))}
        </div>
        ...
        {/* Grid */}
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 xl:grid-cols-4 gap-7">
          {BISD.slice(0, Math.floor(BISD.length / 4) * 4).map((m) => (
            <CoordinatorCard key={m.name} member={m} />
          ))}
        </div>
        ...
        {/* Grid */}
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 xl:grid-cols-4 gap-7">
          {BPWM.slice(0, Math.floor(BPWM.length / 4) * 4).map((m) => (
            <CoordinatorCard key={m.name} member={m} />
          ))}
        </div>
        <div className="flex justify-center gap-7 mt-7">
          {BPWM.slice(Math.floor(BPWM.length / 4) * 4).map((m) => (
            <CoordinatorCard key={m.name} member={m} />
          ))}
        </div>
      </div>
...
export default CoordinatorPage2;
