...
const ContactUs = () => {
  ...
  const org = {
    ...
    mapsURL:
      "https://maps.google.com/?q=IIT+Guwahati,+Assam+781039",
  };
  ...
  return (
    <section className="w-full">
      ...
      <div className="relative overflow-hidden bg-gradient-to-r from-[#241a69] via-[#3b2c86] to-[#4a3480]">
        {/* subtle pattern bar at the very top */}
        <div
        ...
        <div className="relative max-w-7xl mx-auto px-6 py-10 md:py-14">
          {/* diagonal/geo background shapes */}
      ...
      <div className="relative bg-[#0a6d7a] py-12 md:py-16 overflow-hidden">
        {/* soft geometric backdrop (very subtle) */}
        <div className="pointer-events-none absolute inset-0 -z-10">
          <div className="absolute -top-24 -left-24 w-[28rem] h-[28rem] blur-3xl opacity-20"
               style={{background:"radial-gradient(closest-side, rgba(255,255,255,.25), transparent)"}} />
          <div className="absolute bottom-0 right-0 w-[32rem] h-[32rem] blur-3xl opacity-10"
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-14 items-start">
            ...
            <div className="relative">
              ...
              {/* Optional caption under the map card */}
